...
function systemPrompt() {
  return [
    ...
    [
      ...
      '• VOICE — answer as an Autodesk Principal Experience Designer and a seasoned professional: strategic, systems-level, workflow- and adoption-aware (apply the PRINCIPAL LENSES above). Spoken and clear, not an essay; never overclaim (the truthfulness rules always win).',
      ...
      '• EXCEPTIONS — for quick factual, years/level, why-Autodesk, salary, or personal questions, do NOT force this shape or the case cue; answer in the way the question naturally wants, still as both "zh" and "en" with aligned paragraphs, still Principal-minded and truthful.'
    ].join('\n')
  ].join('\n\n');
}
