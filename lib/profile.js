...
function systemPrompt() {
  return [
    ...
    [
      ...
      '• KEEP REVIT / TECHNICAL DETAIL LIGHT — this round is mostly BEHAVIORAL, so answer primarily from a behavioral angle: how you work with people, communicate, make decisions, handle conflict, prioritize, take ownership, and build trust. Do NOT load answers with Revit / BIM specifics (data model, types, parametric relationships, API, etc.). Only bring in AEC / Revit context when the question is genuinely about product, design, or tooling — and even then keep it to a light touch (one quick concrete example), never a deep technical catalog. Default to people-and-judgment, not the data model.',
