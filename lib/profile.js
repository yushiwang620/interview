...
// Full prep-doc text (auto-generated from the interview-prep page by _extract.py;
// excludes salary / relocation / red-line / PII panels by design).
const DOC = require('./doc-knowledge');
...
function systemPrompt() {
  return [
    PERSONA,
    GUARDRAILS,
    'YOUR BACKGROUND DATABASE = sources to weave together: (1) THE ROLE / JD below, (2) Yushi\'s own Experience-Design projects (the KNOWLEDGE BASE = 我的项目), (3) the AUTODESK context, (4) STEPWISE — the Revit stair take-home he prepared for THIS interview, and (5) the FULL PREP DOC below — every prepared answer, project deep-dive and follow-up (追问) question he rehearsed. Ground everything you say in these; do not invent anything beyond them.',
    JD,
    AUTODESK,
    INTERVIEW_CONTEXT,
    'KNOWLEDGE BASE — Experience Design 我的项目 (his real work; ground every project reference here):\n' + kbText(),
    'STEPWISE TAKE-HOME (reserve knowledge for follow-ups about the Revit stair exercise):\n' + STEPWISE,
    'FULL PREP DOC — every prepared script, project deep-dive and follow-up (追问) he rehearsed; your richest grounding. Draw specifics from here, but ADAPT to the exact question asked — do not read it back verbatim:\n' + DOC,
    [
      'ANSWER ROUTING — pick the source and shape that fit the question:',
      '• PORTFOLIO / PROJECT question (Floorcast, IVM, Promptitect, Ask Tom, AI Video, Kaleidoscope, Solar Comfort, Floorish, Sectioneer, PAYETTE Places, AR, Space Strategy, PAYETTE Lens, Pulse, …): ground the answer in that real project — what he built, why, and how — using the KNOWLEDGE BASE and the matching project / follow-up section of the PREP DOC.',
      '• FOLLOW-UP / 追问 question (it matches or resembles a prepared follow-up in the PREP DOC): answer in an organized, ENUMERATED way — clear first / second / third points (or ① ② ③) — reusing the prepared reasoning.',
      '• STEPWISE case-study question: answer from the STEPWISE knowledge and his actual design decisions.',
      '• Otherwise, answer in the shape the question naturally wants. In EVERY case keep the OUTPUT FORMAT (en + zh, paragraph-aligned) and the truthfulness guardrails.'
    ].join('\n'),
    PRINCIPAL_LENS,
    [
