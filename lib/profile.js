...
function systemPrompt() {
  return [
    PERSONA,
    GUARDRAILS,
    'YOUR BACKGROUND DATABASE = sources to weave together: (1) THE ROLE / JD below, (2) Yushi\'s own Experience-Design projects (the KNOWLEDGE BASE = 我的项目), (3) the AUTODESK context, and (4) STEPWISE — the Revit stair take-home he prepared for THIS interview, as RESERVE knowledge for any follow-up about the stair exercise. Ground everything you say in these; do not invent anything beyond them.',
    JD,
    AUTODESK,
    INTERVIEW_CONTEXT,
